...
function Icon$1(_ref) {
    ...
    var className = styles.classNames(styles$3.Icon, color && styles$3[styles.variationName('color', color)], color && color !== 'white' && styles$3.isColored, backdrop && styles$3.hasBackdrop);
...
function Badge$1(_ref) {
    ...
    var className = styles.classNames(styles$5.Badge, status && styles$5[styles.variationName('status', status)], progress && styles$5[styles.variationName('progress', progress)]);
...
function Item$1(_ref) {
  ...
  var className = reactUtilities.classNames(styles$6.Item, disabled && styles$6.disabled, destructive && styles$6.destructive);
...
function Avatar$1(_ref) {
    ...
    var className = styles.classNames(styles$7.Avatar, styles$7[styles.variationName('style', styleClass(nameString))], size && styles$7[styles.variationName('size', size)], finalSource && styles$7.hasImage);
    var imageMarkUp = finalSource ? React.createElement(Image$1, { className: styles$7.Image, source: finalSource, alt: '', role: 'presentation' }) : null;
...
function ButtonGroup$1(_ref) {
    ...
    var contents = reactUtilities.elementChildren(children).map(function (child, index) {
        return React.createElement(Item$3, { button: child, key: index });
    });
    return React.createElement(
        'div',
        { className: className },
...
function Item$6(_ref) {
    ...
    var className = styles.classNames(styles$15.Item, fill && styles$15['Item-fill']);
    return React.createElement(
        'div',
        { className: className },
        children
...
var Stack$1 = function (_React$PureComponent) {
    ...
    _createClass(Stack, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$15.Stack, vertical && styles$15.vertical, spacing && styles$15[styles.variationName('spacing', spacing)], distribution && styles$15[styles.variationName('distribution', distribution)], alignment && styles$15[styles.variationName('alignment', alignment)], wrap === false && styles$15.noWrap);
            var itemMarkup = reactUtilities.elementChildren(children).map(function (child, index) {
                var props = { key: index };
                return reactUtilities.wrapWithComponent(child, Item$6, props);
            });
            return React.createElement(
                'div',
                { className: className },
...
function Section$3(_ref) {
  ...
  var className = styles.classNames(styles$16.Section, subdued && styles$16['Section-subdued'], fullWidth && styles$16['Section-fullWidth']);
  return React.createElement(
    'div',
    { className: className },
    headerContent,
...
var Card$1 = function (_React$PureComponent) {
    ...
    _createClass(Card, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$16.Card, subdued && styles$16.subdued);
...
var FileUpload$1 = function (_React$Component) {
    ...
    _createClass(FileUpload, [{
        ...
        value: function render() {
            ...
            var imageClasses = styles.classNames(styles$35.Image, size && size === 'extraLarge' && styles$35.sizeExtraLarge, size && size === 'large' && styles$35.sizeLarge);
...
var DropZone$1 = function (_React$Component) {
    ...
    _createClass(DropZone, [{
        ...
        value: function render() {
            ...
            var classes = styles.classNames(styles$36.DropZone, outline && styles$36.hasOutline, (active || dragging) && styles$36.isDragging, error && styles$36.hasError, size && size === 'extraLarge' && styles$36.sizeExtraLarge, size && size === 'large' && styles$36.sizeLarge, size && size === 'medium' && styles$36.sizeMedium, size && size === 'small' && styles$36.sizeSmall);
...
var EmptySearchResult$1 = function (_React$PureComponent) {
    ...
    _createClass(EmptySearchResult, [{
        ...
        value: function render() {
            ...
            var illustrationMarkup = withIllustration ? React.createElement(Image$1, { alt: altText, source: emptySearch, className: styles$37.Image, draggable: false }) : null;
            return React.createElement(
                Stack$1,
...
var EmptyState$1 = function (_React$PureComponent) {
  ...
  _createClass(EmptyState, [{
    ...
    value: function render() {
      ...
      var className = styles.classNames(styles$38.EmptyState, imageContained && styles$38.imageContained);
      var imageMarkup = largeImage ? React.createElement(Image$1, { alt: '', role: 'presentation', className: styles$38.Image, source: largeImage, sourceSet: [{ source: image, descriptor: '568w' }, { source: largeImage, descriptor: '1136w' }], sizes: '(max-width: 568px) 60vw' }) : React.createElement(Image$1, { role: 'presentation', alt: '', className: styles$38.Image, source: image });
      var secondaryActionMarkup = secondaryAction ? buttonFrom(secondaryAction, { plain: true }) : null;
      return React.createElement(
        'div',
        { className: className },
...
function ExceptionList$1(_ref) {
  ...
  var items = itemsList.map(function (item, index) {
    ...
    var itemClasses = styles.classNames(styles$40.Item, status && styles$40[styles.variationName('status', status)]);
    var iconMarkup = icon ? React.createElement(Icon$2, { source: icon }) : React.createElement('span', { className: styles$40.Bullet });
    var titleMarkup = title && React.createElement(
      'span',
...
function Group$1(_ref) {
    ...
    var className = styles.classNames(condensed && styles$42.condensed);
    ...
    _createClass(Modal, [{
        ...
        value: function render() {
            ...
            if (open) {
                ...
                var bodyMarkup = src ? React.createElement('iframe', { name: iFrameName, title: iframeTitle, src: src, className: styles$52.IFrame, onLoad: this.handleIFrameLoad, style: { height: iframeHeight + 'px' } }) : React.createElement(
                    Scrollable$2,
...
var Option$1 = function (_React$Component) {
    ...
    _createClass(Option, [{
        ...
        value: function render() {
            ...
            var singleSelectClassName = styles.classNames(styles$53.SingleSelectOption, focused && styles$53.focused, disabled && styles$53.disabled, select && styles$53.select, active && styles$53.active);
            var multiSelectClassName = styles.classNames(styles$53.Label, active && styles$53.active);
...
function Checkbox$4(_ref) {
  ...
  var className = styles.classNames(styles$54.Checkbox, active && styles$54.active);
  return React.createElement(
    'div',
    { className: className },
    ...
    _createClass(Header, [{
        ...
        value: function renderSecondaryActions() {
            ...
            var actionGroupsMarkup = actionGroups.length > 0 ? actionGroups.map(function (_ref) {
                ...
                var detailsClassName = styles.classNames(styles$56.Details, actions && Array.isArray(actions) && actions.length > 0 && styles$56.withActions);
                var detailsMarkup = details ? React.createElement(
                    'div',
...
var Page$1 = function (_React$PureComponent) {
    ...
    _createClass(Page, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$56.Page, fullWidth && styles$56.fullWidth, singleColumn && styles$56.singleColumn);
...
function TextStyle$1(_ref) {
    ...
    var className = styles.classNames(variation && styles$74[styles.variationName('variation', variation)], variation === VariationValue.Code && styles$74.code);
...
function Thumbnail$1(_ref) {
    ...
    var className = styles.classNames(styles$75.Thumbnail, size && styles$75[styles.variationName('size', size)]);
    return React.createElement(
        'span',
        { className: className },
...
function SkeletonDisplayText$1(_ref) {
    ...
    var className = styles.classNames(styles$76.DisplayText, size && styles$76[styles.variationName('size', size)]);
...
var SkeletonPage = function (_React$PureComponent) {
    ...
    _createClass(SkeletonPage, [{
        ...
        value: function render() {
            ...
            var headerClassName = styles.classNames(styles$78.Header, breadcrumbs && styles$78['Header-hasBreadcrumbs'], secondaryActions && styles$78['Header-hasSecondaryActions']);
...
function ProgressBar$1(_ref) {
    ...
    var className = styles.classNames(styles$79.ProgressBar, size && styles$79[styles.variationName('size', size)]);
