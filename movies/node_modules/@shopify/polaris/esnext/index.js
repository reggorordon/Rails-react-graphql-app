...
import { classNames, elementChildren, isElementOfType, variationName, wrapWithComponent } from '@shopify/react-utilities';
import { classNames as classNames$1, variationName as variationName$1 } from '@shopify/react-utilities/styles';
...
function SettingAction$1({ action, children }) {
  return createElement(
    'div',
    { className: styles$1.SettingAction },
    createElement(
      'div',
...
function AccountConnection$1({ connected = false, action, avatarUrl, accountName = '', title, details, termsOfService }) {
    ...
    const termsOfServiceMarkup = termsOfService ? createElement(
        'div',
        { className: styles$2.TermsOfService },
        termsOfService
    ) : null;
...
var styles$3 = {
  ...
  "colorWhite": "p_zo",
  "colorBlack": "p_jf",
  "colorSkyLighter": "p_fz",
  "colorSkyLight": "p_yi",
  "colorSky": "p_ve",
  "colorSkyDark": "p_nd",
  "colorInkLightest": "p_hu",
  "colorInkLighter": "p_iv",
  "colorInkLight": "p_m9",
  "colorInk": "p_ij",
  "colorBlueLighter": "p_x9",
  "colorBlueLight": "p_nu",
  "colorBlue": "p_gw",
  "colorBlueDark": "p_ho",
  "colorBlueDarker": "p_d6",
  "colorIndigoLighter": "p_fa",
  "colorIndigoLight": "p_x0",
  "colorIndigo": "p_os",
  "colorIndigoDark": "p_kv",
  "colorIndigoDarker": "p_na",
  "colorTealLighter": "p_v0",
  "colorTealLight": "p_dm",
  "colorTeal": "p_tw",
  "colorTealDark": "p_re",
  "colorTealDarker": "p_um",
  "colorGreenLighter": "p_zy",
  "colorGreen": "p_dx",
  "colorGreenDark": "p_s5",
  "colorYellowLighter": "p_ga",
  "colorYellow": "p_vy",
  "colorYellowDark": "p_x4",
  "colorOrange": "p_r8",
  "colorOrangeDark": "p_cc",
  "colorRedLighter": "p_i7",
  "colorRed": "p_pu",
  "colorRedDark": "p_dq",
  "colorPurple": "p_go",
  "Svg": "p_tq",
...
function Icon$1({ source, color, backdrop, accessibilityLabel, polaris: { intl } }) {
    ...
    const className = classNames$1(styles$3.Icon, color && styles$3[variationName$1('color', color)], color && color !== 'white' && styles$3.isColored, backdrop && styles$3.hasBackdrop);
    let contentMarkup;
    if (source === 'placeholder') {
        contentMarkup = createElement('div', { className: styles$3.Placeholder });
    } else {
        const iconSource = typeof source === 'string' ? BUNDLED_ICONS[source] : source;
        contentMarkup = iconSource && iconSource.viewBox && iconSource.body && createElement('svg', { className: styles$3.Svg, viewBox: iconSource.viewBox, dangerouslySetInnerHTML: { __html: iconSource.body }, focusable: 'false', 'aria-hidden': 'true' });
    }
    return createElement(
        'span',
        ...
        class WithRef extends Component {
            render() {
                return createElement(
                    Consumer,
                    null,
                    ctx => createElement(WrappedComponent, Object.assign({}, this.props, { ref: ctx.forwardedRef }))
                );
            }
        }
...
// eslint-disable-next-line shopify/strict-component-boundaries
function compose$1(...wrappingFunctions) {
    return function wrapComponent(OriginalComponent) {
        const Result = compose(...wrappingFunctions)(OriginalComponent);
...
function VisuallyHidden$1({ children }) {
    return createElement(
        'span',
        { className: styles$4.VisuallyHidden },
        children
    );
}
...
var styles$5 = {
  ...
  "statusSuccess": "p_lz",
  "statusInfo": "p_iw",
  "statusAttention": "p_ft",
  "statusWarning": "p_yr",
  "statusNew": "p_vd",
  "progressIncomplete": "p_ez",
  "progressPartiallyComplete": "p_x5",
  "progressComplete": "p_kc",
};
...
function Badge$1({ children, status, progress, polaris: { intl } }) {
    const className = classNames$1(styles$5.Badge, status && styles$5[variationName$1('status', status)], progress && styles$5[variationName$1('progress', progress)]);
    let progressMarkup;
    switch (progress) {
...
function Item$1({ badge, content, url, onAction, icon, image, disabled, external, destructive, ellipsis }) {
  const className = classNames(styles$6.Item, disabled && styles$6.disabled, destructive && styles$6.destructive);
  ...
  if (icon) {
    ...
    imageElement = createElement('div', { role: 'presentation', className: styles$6.Image, style: { backgroundImage: `url(${image}` } });
  }
  const contentMarkup = ellipsis && content ? `${content}…` : content;
  const badgeMarkup = badge && createElement(
    'span',
    { className: styles$6.BadgeWrapper },
    createElement(
      Badge$2,
      { status: badge.status },
      badge.content
  ...
  const control = url ? createElement(
    UnstyledLink$2,
    { url: url, onClick: onAction, className: styles$6.Item, external: external },
    contentElement
  ) : createElement(
    'button',
...
function Section$1({ section, hasMultipleSections, onActionAnyItem }) {
    ...
    const actionMarkup = section.items.map((_a, index) => {
        ...
        return createElement(Item$1, Object.assign({ key: `${content}-${index}`, content: content, onAction: handleAction(onAction) }, item));
    });
    const className = section.title ? null : styles$6['Section-withoutTitle'];
...
function Avatar$1({ name, source, initials, customer, size = 'medium', accessibilityLabel, polaris: { intl } }) {
    ...
    const className = classNames$1(styles$7.Avatar, styles$7[variationName$1('style', styleClass(nameString))], size && styles$7[variationName$1('size', size)], finalSource && styles$7.hasImage);
    const imageMarkUp = finalSource ? createElement(Image$1, { className: styles$7.Image, source: finalSource, alt: '', role: 'presentation' }) : null;
    // Use `dominant-baseline: central` instead of `dy` when Edge supports it.
    const verticalOffset = '0.35em';
    const initialsMarkup = initials ? createElement(
        'span',
        { className: styles$7.Initials },
        createElement(
            'svg',
            { className: styles$7.Svg, viewBox: '0 0 48 48' },
            createElement(
                'text',
...
function Spinner$1({ size = 'large', color = 'teal', accessibilityLabel, polaris: { intl } }) {
    ...
    const className = classNames$1(styles$8.Spinner, color && styles$8[variationName$1('color', color)], size && styles$8[variationName$1('size', size)]);
...
function Indicator$1({ pulse = true }) {
    const className = classNames$1(styles$9.Indicator, pulse && styles$9.pulseIndicator);
...
function Button$1({ id, url, disabled, loading, children, accessibilityLabel, ariaControls, ariaExpanded, onClick, onFocus, onBlur, external, icon, primary, outline, destructive, disclosure, plain, submit, size = 'medium', fullWidth, polaris: { intl } }) {
  const indicator = false;
  const isDisabled = disabled || loading;
  const className = classNames(styles$10.Button, primary && styles$10.primary, outline && styles$10.outline, destructive && styles$10.destructive, isDisabled && styles$10.disabled, loading && styles$10.loading, plain && styles$10.plain, size && size !== 'medium' && styles$10[variationName('size', size)], fullWidth && styles$10.fullWidth, icon && children == null && styles$10.iconOnly);
  ...
  let iconMarkup;
  if (icon) {
    const iconInner = isIconSource(icon) ? createElement(Icon$2, { source: loading ? 'placeholder' : icon }) : icon;
...
class Item$3 extends PureComponent {
    ...
    render() {
        ...
        const className = classNames$1(styles$12.Item, focused && styles$12['Item-focused'], button.props.plain && styles$12['Item-plain']);
        return createElement(
            'div',
...
function ButtonGroup$1({ children, segmented, fullWidth, connectedTop }) {
    const className = classNames$1(styles$12.ButtonGroup, segmented && styles$12.segmented, fullWidth && styles$12.fullWidth, connectedTop && styles$12.connectedTop);
    const contents = elementChildren(children).map((child, index) => createElement(Item$3, { button: child, key: index }));
    return createElement(
        'div',
        { className: className },
        contents
...
class Banner$1 extends PureComponent {
    render() {
        ...
        const className = classNames$1(styles$13.Banner, status && styles$13[variationName$1('status', status)], onDismiss && styles$13.hasDismiss, withinContentContainer ? styles$13.withinContentContainer : styles$13.withinPage);
        const id = uniqueID();
        ...
        if (title) {
            ...
            headingMarkup = createElement(
                'div',
                { className: styles$13.Heading, id: headingID },
                createElement(
                    Heading$1,
                    { element: 'p' },
                    title
        ...
        if (children || actionMarkup) {
            ...
            contentMarkup = createElement(
                'div',
                { className: styles$13.Content, id: contentID },
                children,
                actionMarkup
            );
        }
...
function secondaryActionFrom(action) {
    if (action.url) {
        return createElement(
            UnstyledLink$2,
            { className: styles$13.SecondaryAction, url: action.url, external: action.external },
            createElement(
                'span',
    ...
    return createElement(
        'button',
        { className: styles$13.SecondaryAction, onClick: action.onAction },
        createElement(
            'span',
            { className: styles$13.Text },
            action.content
...
class Breadcrumbs$1 extends PureComponent {
  render() {
    ...
    const breadcrumbMarkup = 'url' in breadcrumb ? createElement(
      UnstyledLink$2,
      { key: content, url: breadcrumb.url, className: styles$14.Breadcrumb, onMouseUp: handleMouseUpByBlurring },
      contentMarkup
    ) : createElement(
      'button',
      { key: content, className: styles$14.Breadcrumb, onClick: breadcrumb.onAction, onMouseUp: handleMouseUpByBlurring, type: 'button' },
      contentMarkup
    );
    return (
...
var styles$15 = {
  ...
  "vertical": "p_af",
  "spacingNone": "p_cm",
  "spacingExtraTight": "p_f7",
  "spacingTight": "p_mz",
  "spacingLoose": "p_sy",
  "spacingExtraLoose": "p_mi",
  "distributionLeading": "p_cq",
  "distributionTrailing": "p_zh",
  "distributionCenter": "p_zs",
  "distributionEqualSpacing": "p_f0",
  "distributionFill": "p_sr",
  "distributionFillEvenly": "p_mf",
  "alignmentLeading": "p_pl",
  "alignmentTrailing": "p_jq",
  "alignmentCenter": "p_xi",
  "alignmentFill": "p_hz",
  "alignmentBaseline": "p_e6",
  "Item-fill": "p_lk",
};

function Item$5({ children, fill }) {
    const className = classNames$1(styles$15.Item, fill && styles$15['Item-fill']);
    return createElement(
        'div',
        { className: className },
        children
...
class Stack$1 extends PureComponent {
    render() {
        ...
        const className = classNames$1(styles$15.Stack, vertical && styles$15.vertical, spacing && styles$15[variationName$1('spacing', spacing)], distribution && styles$15[variationName$1('distribution', distribution)], alignment && styles$15[variationName$1('alignment', alignment)], wrap === false && styles$15.noWrap);
...
var styles$16 = {
  ...
  "Header": "p_fg",
  "Section": "p_sk",
  "Section-fullWidth": "p_q6",
  "Section-subdued": "p_xv",
  "SectionHeader": "p_np",
  "Footer": "p_pi",
};
...
function Subheading$1({ element: Element = 'h3', children }) {
    ...
    return createElement(
        Element,
        { 'aria-label': ariaLabel, className: styles$17.Subheading },
        children
    );
}

function Section$3({ children, title, subdued, fullWidth }) {
  const headerContent = title ? createElement(
    'div',
    { className: styles$16.SectionHeader },
    createElement(
      Subheading$1,
      null,
      title
  ...
  const className = classNames$1(styles$16.Section, subdued && styles$16['Section-subdued'], fullWidth && styles$16['Section-fullWidth']);
  return createElement(
    'div',
    { className: className },
    headerContent,
...
class Card$1 extends PureComponent {
    ...
    render() {
        ...
        const className = classNames$1(styles$16.Card, subdued && styles$16.subdued);
...
function TextContainer$1({ spacing, children }) {
    const className = classNames$1(styles$18.TextContainer, spacing && styles$18[variationName$1('spacing', spacing)]);
    return createElement(
        'div',
        { className: className },
        children
...
function Choice$1({ id, label, disabled, error, children, labelHidden, helpText }) {
  const className = classNames$1(styles$22.Choice, labelHidden && styles$22.labelHidden, disabled && styles$22.disabled);
...
function Checkbox$1({ id = getUniqueID(), label, labelHidden, helpText, checked = false, error, disabled, onChange, onFocus, onBlur, name, value }) {
    ...
    const wrapperClassName = classNames$1(styles$23.Checkbox, error && styles$23.error);
    ...
    const inputClassName = classNames$1(styles$23.Input, isIndeterminate && styles$23['Input-indeterminate']);
    return (
...
function ChoiceList$1({ title, titleHidden, allowMultiple, choices, selected, onChange = noop, error, name = getUniqueID$1() }) {
    ...
    const className = classNames$1(styles$25.ChoiceList, titleHidden && styles$25.titleHidden);
    ...
    const errorMarkup = error && createElement(
        'div',
        { className: styles$25.ChoiceError },
...
class Collapsible$1 extends Component {
    ...
    render() {
        ...
        const wrapperClassName = classNames$1(styles$26.Collapsible, open && styles$26.open, animating && styles$26.animating);
...
class Item$7 extends PureComponent {
    ...
    render() {
        ...
        const className = classNames$1(styles$28.Item, focused && styles$28['Item-focused'], position === ItemPosition.Primary ? styles$28['Item-primary'] : styles$28['Item-connection']);
        return createElement(
            'div',
...
function Cell$1({ height, content, contentType, fixed, truncate, header, total, footer, sorted, sortable, sortDirection, defaultSortDirection, polaris: { intl: { translate } }, onSort }) {
  ...
  const className = classNames$1(styles$29.Cell, fixed && styles$29['Cell-fixed'], fixed && truncate && styles$29['Cell-truncated'], header && styles$29['Cell-header'], total && styles$29['Cell-total'], footer && styles$29['Cell-footer'], numeric && styles$29['Cell-numeric'], sortable && styles$29['Cell-sortable'], sorted && styles$29['Cell-sorted']);
  const headerClassName = classNames$1(header && styles$29.Heading, header && contentType === 'text' && styles$29['Heading-left']);
  const iconClassName = classNames$1(sortable && styles$29.Icon);
  const style = {
...
function Navigation$1({ columnVisibilityData, isScrolledFarthestLeft, isScrolledFarthestRight, navigateTableLeft, navigateTableRight, polaris: { intl: { translate } } }) {
    const pipMarkup = columnVisibilityData.map((column, index) => {
        const className = classNames$1(styles$29.Pip, column.isVisible && styles$29['Pip-visible']);
...
class DataTable$1 extends PureComponent {
    ...
    render() {
        ...
        const className = classNames$1(styles$29.DataTable, collapsed && styles$29.collapsed, footerContent && styles$29.hasFooter);
        const wrapperClassName = classNames$1(styles$29.TableWrapper, collapsed && styles$29.collapsed);
        const footerClassName = classNames$1(footerContent && styles$29.TableFoot);
        ...
        return createElement(
            ...
            createElement(
                ...
                createElement(
                    'div',
                    { className: styles$29.ScrollContainer, ref: this.scrollContainer, style: style },
                    ...
                    createElement(
                        'table',
                        { className: styles$29.Table, ref: this.table },
                        createElement(
                            'thead',
                            null,
                            headingMarkup,
    ...
    calculateColumnVisibilityData(collapsed) {
        ...
        if (collapsed && table && scrollContainer && dataTable) {
            const headerCells = table.querySelectorAll('[class*=header]');
    ...
    defaultRenderRow(row, index) {
        const className = classNames$1(styles$29.TableRow);
...
class Day$1 extends PureComponent {
    ...
    render() {
        ...
        const className = classNames$1(styles$30.Day, selected && styles$30['Day-selected'], disabled && styles$30['Day-disabled'], today && styles$30['Day-today'], (inRange || inHoveringRange) && !disabled && styles$30['Day-inRange']);
...
function Weekday$1({ label, title, current }) {
    const className = classNames$1(styles$30.Weekday, current && styles$30['Weekday-current']);
    return createElement(
        'div',
...
function Month$1({ focusedDate, selected, hoverDate, disableDatesBefore, disableDatesAfter, allowRange, onChange = noop, onHover = noop, onFocus = noop, month, year, weekStartsOn }) {
    ...
    const className = classNames$1(styles$30.Title, current && styles$30['Month-current']);
...
function DisplayText$1({ element: Element = 'p', children, size = 'medium' }) {
    const className = classNames$1(styles$32.DisplayText, size && styles$32[variationName$1('size', size)]);
    return createElement(
        Element,
        { className: className },
        children
...
function Label$1({ children, id, hidden }) {
    const className = classNames$1(styles$33.Label, hidden && styles$33.hidden);
    return createElement(
        'div',
        { className: className },
        createElement(
...
function Labelled$1(_a) {
  ...
  const className = classNames$1(labelHidden && styles$34.hidden);
...
const { Provider: Provider$1, Consumer: Consumer$1 } = createContext({
    size: 'extraLarge',
    type: 'file'
});
...
class FileUpload$1 extends Component {
    ...
    render() {
        ...
        const { actionTitle, actionHint } = this.state;
        const imageClasses = classNames$1(styles$35.Image, size && size === 'extraLarge' && styles$35.sizeExtraLarge, size && size === 'large' && styles$35.sizeLarge);
        ...
        return createElement(
            'div',
            { className: styles$35.FileUpload },
            smallView,
            mediumView,
            largeView,
            extraLargeView
...
class DropZone$1 extends Component {
    ...
    render() {
        ...
        const classes = classNames$1(styles$36.DropZone, outline && styles$36.hasOutline, (active || dragging) && styles$36.isDragging, error && styles$36.hasError, size && size === 'extraLarge' && styles$36.sizeExtraLarge, size && size === 'large' && styles$36.sizeLarge, size && size === 'medium' && styles$36.sizeMedium, size && size === 'small' && styles$36.sizeSmall);
        const dragOverlay = (active || dragging) && !error && overlay ? createElement(
            'div',
            { className: styles$36.Overlay },
            createElement(
                Stack$1,
                { vertical: true, spacing: 'tight' },
        ...
        const labelledDropzoneMarkup = label ? createElement(
            Labelled$1,
...
class EmptySearchResult$1 extends PureComponent {
    render() {
        ...
        const illustrationMarkup = withIllustration ? createElement(Image$1, { alt: altText, source: emptySearch, className: styles$37.Image, draggable: false }) : null;
        return createElement(
            Stack$1,
...
class EmptyState$1 extends PureComponent {
  render() {
    ...
    const className = classNames$1(styles$38.EmptyState, imageContained && styles$38.imageContained);
    const imageMarkup = largeImage ? createElement(Image$1, { alt: '', role: 'presentation', className: styles$38.Image, source: largeImage, sourceSet: [{ source: image, descriptor: '568w' }, { source: largeImage, descriptor: '1136w' }], sizes: '(max-width: 568px) 60vw' }) : createElement(Image$1, { role: 'presentation', alt: '', className: styles$38.Image, source: image });
    const secondaryActionMarkup = secondaryAction ? buttonFrom(secondaryAction, { plain: true }) : null;
    return createElement(
      'div',
      { className: className },
      createElement(
        'div',
        { className: styles$38.Section },
        createElement(
          'div',
          { className: styles$38.DetailsContainer },
          createElement(
            'div',
            { className: styles$38.Details },
            createElement(
              TextContainer$1,
              null,
              createElement(
        ...
        createElement(
          'div',
          { className: styles$38.ImageContainer },
          imageMarkup
        )
      )
    );
...
function ExceptionList$1({ items: itemsList }) {
  const items = itemsList.map((item, index) => {
    ...
    const itemClasses = classNames$1(styles$40.Item, status && styles$40[variationName$1('status', status)]);
    const iconMarkup = icon ? createElement(Icon$2, { source: icon }) : createElement('span', { className: styles$40.Bullet });
    const titleMarkup = title && createElement(
      'span',
    ...
    const descriptionMarkup = description && createElement(
      'span',
      { className: styles$40.Description },
      description
    );
  ...
  return createElement(
    'ul',
    { className: styles$40.ExceptionList },
    items
  );
}
...
function FooterHelp$1({ children }) {
  return createElement(
    'div',
    { className: styles$41.FooterHelp },
    createElement(
      'div',
      { className: styles$41.Content },
      createElement(
        'div',
...
function Group$1({ children, condensed, title, helpText }) {
    const className = classNames$1(condensed && styles$42.condensed);
    ...
    if (helpText) {
        ...
        helpTextElement = createElement(
            'div',
            { id: helpTextID, className: styles$42.HelpText },
            helpText
        );
    }
    if (title) {
        ...
        titleElement = createElement(
            'div',
            { id: titleID, className: styles$42.Title },
            title
        );
    }
...
class FormLayout$1 extends PureComponent {
    render() {
        ...
        return createElement(
            'div',
            { className: styles$42.FormLayout },
...
function KeyboardKey$1({ children }) {
    ...
    return createElement(
        'kbd',
        { className: styles$43.KeyboardKey },
        key
    );
}
...
var styles$44 = {
  "Layout": "p_rs",
  "Section": "p_h3",
  "Section-secondary": "p_xe",
  "Section-fullWidth": "p_tl",
  "AnnotatedSection": "p_ww",
  "AnnotationWrapper": "p_wr",
  "AnnotationContent": "p_mo",
  "Annotation": "p_iy",
  "AnnotationDescription": "p_xm",
};
...
function AnnotatedSection$1(props) {
  ...
  return createElement(
    'div',
    { className: styles$44.AnnotatedSection },
    createElement(
      'div',
      { className: styles$44.AnnotationWrapper },
      createElement(
        'div',
        { className: styles$44.Annotation },
        createElement(
          TextContainer$1,
          null,
          createElement(
          ...
          descriptionMarkup && createElement(
            'div',
            { className: styles$44.AnnotationDescription },
            descriptionMarkup
          )
        )
      ),
      createElement(
        'div',
        { className: styles$44.AnnotationContent },
        children
      )
    )
  );
...
function Section$5({ children, secondary, fullWidth }) {
    const className = classNames$1(styles$44.Section, secondary && styles$44['Section-secondary'], fullWidth && styles$44['Section-fullWidth']);
    return createElement(
        'div',
        { className: className },
        children
...
function Link$2({ url, children, onClick, external, id }) {
  return url ? createElement(
    UnstyledLink$2,
    { onClick: onClick, className: styles$45.Link, url: url, external: external, id: id },
    children
  ) : createElement(
    'button',
    { onClick: onClick, className: styles$45.Link, id: id },
    children
  );
}
...
class ContentList extends PureComponent {
    render() {
        ...
        const className = classNames$1(styles$46.List, type && styles$46[variationName$1('type', type)]);
...
function Dialog$1(_a) {
  ...
  const classes = classNames$1(styles$47.Modal, large && styles$47.sizeLarge, limitHeight && styles$47.limitHeight);
...
const fadeUpClasses = {
  enter: classNames$1(styles$47.animateFadeUp, styles$47.entering),
  enterActive: classNames$1(styles$47.animateFadeUp, styles$47.entered),
  exit: classNames$1(styles$47.animateFadeUp, styles$47.exiting),
  exitActive: classNames$1(styles$47.animateFadeUp, styles$47.exited)
};
function FadeUp(_a) {
  var { children } = _a,
...
function CloseButton$1({ title = true, onClick }) {
    const className = classNames(styles$49.CloseButton, !title && styles$49.withoutTitle);
    return createElement(
        'button',
...
function Header$3({ id, children, onClose }) {
  ...
  return createElement(
    'div',
    { className: styles$50.Header },
    createElement(
      'div',
      { id: id, className: styles$50.Title },
      createElement(
        DisplayText$1,
    ...
    createElement(CloseButton$1, { onClick: handleClose })
  );
}
...
function Section$7({ children, flush = false, subdued = false }) {
    const className = classNames$1(styles$51.Section, flush && styles$51.flush, subdued && styles$51.subdued);
    return createElement(
        'section',
        { className: className },
        children
    ...
    render() {
        ...
        if (open) {
            ...
            const body = loading ? createElement(
                'div',
                { className: styles$52.Spinner },
                createElement(Spinner$2, null)
            ) : content;
            const bodyMarkup = src ? createElement('iframe', { name: iFrameName, title: iframeTitle, src: src, className: styles$52.IFrame, onLoad: this.handleIFrameLoad, style: { height: `${iframeHeight}px` } }) : createElement(
                Scrollable$2,
                { shadow: true, className: styles$52.Body },
                body
            );
            const headerMarkup = title ? createElement(
                ...
                title
            ) : createElement(CloseButton$1, { onClick: handleClose, title: false });
            dialog = createElement(
                ...
                createElement(
                    'div',
                    { className: styles$52.BodyWrapper },
                    bodyMarkup
                ),
                footerMarkup
            );
            backdrop = createElement('div', { className: styles$52.Backdrop, onClick: handleClose });
        }
...
class Option$1 extends Component {
    ...
    render() {
        ...
        const mediaMarkup = media ? createElement(
            'div',
            { className: styles$53.Media },
            media
        ) : null;
        const singleSelectClassName = classNames$1(styles$53.SingleSelectOption, focused && styles$53.focused, disabled && styles$53.disabled, select && styles$53.select, active && styles$53.active);
        const multiSelectClassName = classNames$1(styles$53.Label, active && styles$53.active);
        ...
        return createElement(
            'li',
            { key: id, className: styles$53.Option, tabIndex: -1, 'aria-selected': active, role: role },
            scrollMarkup,
            optionMarkup
        );
    }
...
function Checkbox$4({ id = getUniqueID$6(), checked = false, disabled, active, onChange, name, value, role }) {
  const className = classNames$1(styles$54.Checkbox, active && styles$54.active);
  return createElement(
    'div',
    { className: className },
    createElement('input', { id: id, name: name, value: value, type: 'checkbox', checked: checked, disabled: disabled, className: styles$54.Input, 'aria-checked': checked, onChange: onChange, role: role }),
    createElement('div', { className: styles$54.Backdrop }),
    createElement(
      'div',
      { className: styles$54.Icon },
...
class OptionList$1 extends Component {
    ...
    render() {
        ...
        const optionsMarkup = optionsExist ? normalizedOptions.map(({ title, options }, sectionIndex) => {
            const titleMarkup = title ? createElement(
                'p',
                { className: styles$55.Title, role: 'presentation' },
                title
            ) : null;
            ...
            return createElement(
                ...
                createElement(
                    'ul',
                    { className: styles$55.Options, id: this.id, role: role, 'aria-multiselectable': allowMultiple },
                    optionsMarkup
                )
            );
        }) : null;
        return createElement(
            'ul',
            { className: styles$55.OptionList },
            optionsMarkup
        );
    }
...
var styles$56 = {
  ...
  "Content": "p_fy",
  "Header": "p_q3",
  "Header-hasPagination": "p_m1",
  "Header-hasBreadcrumbs": "p_ma",
  "Header-hasSecondaryActions": "p_on",
  "Header-hasSeparator": "p_sx",
  "Header-hasRollup": "p_tt",
  "IndividualActions": "p_xz",
  "Rollup": "p_gv",
  "Navigation": "p_bc",
  "Pagination": "p_my",
  "MainContent": "p_s9",
  "TitleAndActions": "p_dn",
  "Title": "p_xq",
  "Title-hidden": "p_ph",
  "Actions": "p_fi",
  "SecondaryActions": "p_mb",
  "Action": "p_ru",
  "ActionGroup": "p_gr",
  "PrimaryAction": "p_s1",
  "ActionIcon": "p_l1",
...
function Action$1({ icon, url, external, onAction, children, disclosure, accessibilityLabel, disabled, showIndicator, hasIndicator }) {
  const iconMarkup = icon ? createElement(
    'span',
    { className: styles$56.ActionIcon },
    createElement(Icon$2, { source: icon })
  ) : null;
  const disclosureIconMarkup = disclosure ? createElement(
    'span',
  ...
  const contentMarkup = iconMarkup || disclosureIconMarkup ? createElement(
    'span',
    { className: styles$56.ActionContent },
    iconMarkup,
    createElement(
      'span',
      null,
  ...
  if (url) {
    return createElement(
      UnstyledLink$2,
      { key: children, external: external, url: url, onMouseUp: handleMouseUpByBlurring, className: styles$56.Action, 'aria-label': accessibilityLabel },
      contentMarkup
    );
  }
  const indicatorMarkup = false && showIndicator && !hasIndicator && createElement(Indicator$1, null);
  const className = classNames(styles$56.Action, disabled && styles$56.disabled, icon && children == null && styles$56.iconOnly, false && showIndicator && styles$56['Action-outline']);
  return createElement(
    'button',
...
class Scrollable$1 extends Component {
    ...
    render() {
        ...
        const finalClassName = classNames$1(className, styles$57.Scrollable, vertical && styles$57.vertical, horizontal && styles$57.horizontal, topShadow && styles$57.hasTopShadow, bottomShadow && styles$57.hasBottomShadow);
        return createElement(
            'div',
...
class PositionedOverlay$1 extends PureComponent {
    ...
    render() {
        ...
        const className = classNames$1(styles$58.PositionedOverlay, fixed && styles$58.fixed);
        return createElement(
            'div',
...
class TooltipOverlay$1 extends PureComponent {
    ...
    renderTooltip(overlayDetails) {
        ...
        const containerClassName = classNames$1(styles$59.Tooltip, light && styles$59.light, measuring && styles$59.measuring, positioning === 'above' && styles$59.positionedAbove);
...
function Pagination$1({ hasNext, hasPrevious, nextURL, previousURL, onNext, onPrevious, nextTooltip, previousTooltip, nextKeys, previousKeys, plain, accessibilityLabel, polaris: { intl } }) {
    ...
    const className = classNames(styles$60.Pagination, plain && styles$60.plain);
...
var styles$61 = {
  ...
  "measuring": "p_t9",
  "exiting": "p_o1",
  "positionedAbove": "p_kq",
  "Wrapper": "p_xu",
  "Content-fullHeight": "p_a1",
  "Pane": "p_x8",
  "Pane-fixed": "p_b9",
  "Section": "p_q7",
  "FocusTracker": "p_hy",
...
function Pane$1({ fixed, sectioned, children }) {
    const className = classNames$1(styles$61.Pane, fixed && styles$61['Pane-fixed']);
...
class PopoverOverlay$1 extends PureComponent {
    ...
    renderPopover(transitionStatus, overlayDetails) {
        ...
        const className = classNames$1(styles$61.Popover, transitionStatus && animationVariations(transitionStatus), positioning === 'above' && styles$61.positionedAbove, fullWidth && styles$61.fullWidth, measuring && styles$61.measuring);
        this.transitionStatus = transitionStatus;
        const contentStyles = measuring ? undefined : { height: desiredHeight };
        const contentClassNames = classNames$1(styles$61.Content, fullHeight && styles$61['Content-fullHeight']);
...
class Header$5 extends PureComponent {
    ...
    render() {
        ...
        const className = classNames$1(styles$56.Header, titleHidden && styles$56['Title-hidden'], pagination && styles$56['Header-hasPagination'], separator && styles$56['Header-hasSeparator'], breadcrumbs && breadcrumbs.length && styles$56['Header-hasBreadcrumbs'], this.hasRollup && styles$56['Header-hasRollup'], secondaryActions && secondaryActions.length && styles$56['Header-hasSecondaryActions']);
        ...
        return primaryActionMarkup ? createElement(
            ...
            createElement(
                'div',
                { className: styles$56.MainContent },
                createElement(
                    'div',
                    { className: styles$56.TitleAndActions },
                    titleMarkup,
                    actionsMarkup
                ),
                primaryActionMarkup
    ...
    renderSecondaryActions() {
        ...
        const actionGroupsMarkup = actionGroups.length > 0 ? actionGroups.map(({ title, icon, actions, details }) => {
            const detailsClassName = classNames$1(styles$56.Details, actions && Array.isArray(actions) && actions.length > 0 && styles$56.withActions);
            const detailsMarkup = details ? createElement(
                'div',
            ...
            return createElement(
                'div',
                { className: styles$56.ActionGroup, key: `ActionGroup-${title}` },
                createElement(
                    Popover$1,
        ...
        return createElement(
            'div',
            { className: styles$56.SecondaryActions },
            rollupMarkup,
            createElement(
                'div',
                { className: styles$56.IndividualActions },
                secondaryActionMarkup,
                actionGroupsMarkup
            )
        );
...
class Page$1 extends PureComponent {
    ...
    render() {
        ...
        const className = classNames$1(styles$56.Page, fullWidth && styles$56.fullWidth, singleColumn && styles$56.singleColumn);
...
class RangeSlider$1 extends PureComponent {
    ...
    render() {
        ...
        const className = classNames$1(styles$63.RangeSlider, error && styles$63.error, disabled && styles$63.disabled);
        return createElement(
            Labelled$1,
...
function Select$1({ options: optionsProp, groups: groupsProp, label, labelAction, labelHidden: labelHiddenProp, labelInline, disabled, helpText, placeholder, id = getUniqueID$12(), name, value = PLACEHOLDER_VALUE, error, onChange, onFocus, onBlur }) {
    ...
    const className = classNames$1(styles$64.Select, error && styles$64.error, disabled && styles$64.disabled);
...
var styles$65 = {
  "CheckableButton": "p_ki",
  "CheckableButton-measuring": "p_gd",
  "CheckableButton-plain": "p_ro",
  "CheckableButton-selectMode": "p_pd",
  "CheckableButton-selected": "p_in",
  "Checkbox": "p_z6",
  "Label": "p_k6",
};

function CheckableButton$1({ accessibilityLabel, label = '', onToggleAll, selected, selectMode, plain, measuring, disabled }) {
    const className = plain ? classNames$1(styles$65.CheckableButton, styles$65['CheckableButton-plain']) : classNames$1(styles$65.CheckableButton, selectMode && styles$65['CheckableButton-selectMode'], selected && styles$65['CheckableButton-selected'], measuring && styles$65['CheckableButton-measuring']);
    return createElement(
        'div',
...
var styles$66 = {
  "Button": "p_ak",
  "Group-measuring": "p_vk",
  "Group": "p_yf",
  "Group-entering": "p_vj",
  "Group-exiting": "p_gz",
  "Group-entered": "p_yo",
  "Group-exited": "p_c0",
  "Group-smallScreen": "p_nz",
  "Group-largeScreen": "p_m8",
  "ButtonGroup": "p_je",
  "Button-cancel": "p_z8",
  "Popover": "p_qe",
  "ActionContent": "p_e9",
  "ActionIcon": "p_g5",
  "disabled": "p_xf",
  "PaginatedSelectAll": "p_lv",
  "Slide": "p_ji",
  "Slide-appear": "p_i3",
  "Slide-enter": "p_zm",
  "Slide-exit": "p_iq",
  "Slide-appearing": "p_l3",
  "Slide-entering": "p_yu",
};
...
class BulkActionButton extends PureComponent {
    ...
    render() {
        ...
        const className = classNames(styles$66.Button, disabled && styles$66.disabled);
        return createElement(
            'button',
...
const slideClasses = {
    appear: classNames$1(styles$66.Slide, styles$66['Slide-appear']),
    appearActive: classNames$1(styles$66.Slide, styles$66['Slide-appearing']),
    enter: classNames$1(styles$66.Slide, styles$66['Slide-enter']),
    enterActive: classNames$1(styles$66.Slide, styles$66['Slide-entering']),
    exit: classNames$1(styles$66.Slide, styles$66['Slide-exit'])
};
class BulkActions$1 extends PureComponent {
    ...
    render() {
        ...
        const cancelButtonClassName = classNames$1(styles$66.Button, styles$66['Button-cancel']);
        ...
        const smallScreenGroup = createElement(
            ...
            status => {
                const smallScreenGroupClassName = classNames$1(styles$66.Group, styles$66['Group-smallScreen'], styles$66[`Group-${status}`]);
                return createElement(
                    'div',
        ...
        const largeScreenGroup = createElement(
            ...
            status => {
                const largeScreenGroupClassName = classNames$1(styles$66.Group, styles$66['Group-largeScreen'], !measuring && styles$66[`Group-${status}`], measuring && styles$66['Group-measuring']);
                return createElement(
                    'div',
...
const { Provider: Provider$2, Consumer: Consumer$2 } = createContext({
    selectMode: false,
    resourceName: {
...
class Item$13 extends PureComponent {
    ...
    render() {
        ...
        const className = classNames$1(styles$69.Item, focused && styles$69.focused, selectable && styles$69.selectable, selected && styles$69.selected, selectMode && styles$69.selectMode, persistActions && styles$69.persistActions, focusedInner && styles$69.focusedInner);
...
var Item$14 = compose(withContext$1(Consumer$2), withAppProvider())(Item$13);

var styles$70 = {
  "FiltersWrapper": "p_vo",
  "ResourceList": "p_b4",
  "HeaderOuterWrapper": "p_cz",
  "HeaderWrapper-disabled": "p_w8",
  "HeaderWrapper-overlay": "p_h9",
  "HeaderWrapper": "p_j2",
  "HeaderWrapper-isSticky": "p_m7",
  "HeaderContentWrapper": "p_tn",
  "HeaderWrapper-inSelectMode": "p_ex",
  "SortWrapper": "p_f2",
  "HeaderWrapper-hasSelect": "p_m6",
  "HeaderWrapper-hasSort": "p_rp",
  "SortLabel": "p_aq",
  "ItemCountTextWrapper": "p_ym",
  "BulkActionsWrapper": "p_gi",
  "CheckableButtonWrapper": "p_oh",
  "SelectButtonWrapper": "p_k4",
  "EmptySearchResultWrapper": "p_au",
  "ResourceListWrapper": "p_ea",
  "ItemWrapper": "p_lb",
  "SpinnerContainer": "p_wy",
  "LoadingOverlay": "p_e2",
  "DisabledPointerEvents": "p_t2",
};
    ...
    render() {
        ...
        const headerMarkup = (showHeader || needsHeader) && listNode && itemsExist && createElement(
            ...
            createElement(
                ...
                isSticky => {
                    const headerClassName = classNames$1(styles$70.HeaderWrapper, sortOptions && sortOptions.length > 0 && styles$70['HeaderWrapper-hasSort'], this.selectable && styles$70['HeaderWrapper-hasSelect'], loading && styles$70['HeaderWrapper-disabled'], this.selectable && selectMode && styles$70['HeaderWrapper-inSelectMode'], isSticky && styles$70['HeaderWrapper-isSticky']);
                    return createElement(
                        'div',
        ...
        const resourceListClassName = classNames$1(styles$70.ResourceList, loading && styles$70.disabledPointerEvents);
...
var styles$71 = {
  ...
  "Item": "p_dp",
  "DisclosureTab": "p_gs",
  "DisclosureTab-visible": "p_wl",
  "DisclosureActivator": "p_xy",
  "TabMeasurer": "p_n8",
};
...
class Item$16 extends PureComponent {
    ...
    render() {
        ...
        const sharedProps = {
            ...
            onClick,
            className: styles$71.Item,
            'aria-controls': panelID,
            'aria-selected': false,
            'aria-label': accessibilityLabel
        };
        const markup = url ? createElement(UnstyledLink$2, Object.assign({ url }, sharedProps), children) : createElement(
            'button',
...
class Tab$1 extends PureComponent {
    ...
    render() {
        ...
        const className = classNames$1(styles$71.Tab, selected && styles$71['Tab-selected']);
        let tabIndex;
...
class TabMeasurer$1 extends PureComponent {
    ...
    render() {
        ...
        const classname = classNames$1(styles$71.Tabs, styles$71.TabMeasurer);
        return createElement(
            'div',
...
class Tabs$1 extends PureComponent {
    ...
    render() {
        ...
        const classname = classNames$1(styles$71.Tabs, fitted && styles$71.fitted, disclosureActivatorVisible && styles$71.fillSpace);
        const disclosureTabClassName = classNames$1(styles$71.DisclosureTab, disclosureActivatorVisible && styles$71['DisclosureTab-visible']);
        const activator = createElement(
            'button',
...
function Tag$1({ children, disabled = false, onRemove, polaris: { intl } }) {
  const className = classNames(disabled && styles$72.disabled, styles$72.Tag);
...
class TextField$1 extends PureComponent {
    ...
    render() {
        ...
        const className = classNames$1(styles$73.TextField, Boolean(value) && styles$73.hasValue, disabled && styles$73.disabled, readOnly && styles$73.readOnly, error && styles$73.error, multiline && styles$73.multiline, this.state.focus && styles$73.focus);
        ...
        const inputClassName = classNames$1(styles$73.Input, suffix && styles$73['Input-suffixed']);
...
var styles$74 = {
  "variationPositive": "p_g7",
  "variationNegative": "p_mv",
  "variationCode": "p_ri",
  "variationStrong": "p_un",
  "variationSubdued": "p_o6",
};
...
function TextStyle$1({ variation, children }) {
    const className = classNames$1(variation && styles$74[variationName$1('variation', variation)], variation === VariationValue.Code && styles$74.code);
...
function Thumbnail$1({ source, alt, size = 'medium' }) {
    const className = classNames$1(styles$75.Thumbnail, size && styles$75[variationName$1('size', size)]);
    return createElement(
        'span',
        { className: className },
        createElement(Image$1, { alt: alt, source: source, className: styles$75.Image })
    );
}
...
function SkeletonDisplayText$1({ size = 'medium' }) {
    const className = classNames$1(styles$76.DisplayText, size && styles$76[variationName$1('size', size)]);
    return createElement('div', { className: className });
}

var styles$77 = {
  "SkeletonBodyTextContainer": "p_of",
  "SkeletonBodyText": "p_rj",
};

function SkeletonBodyText$1({ lines = 3 }) {
    const bodyTextLines = [];
    for (let i = 0; i < lines; i++) {
        bodyTextLines.push(createElement('div', { className: styles$77.SkeletonBodyText, key: i }));
    }
    return createElement(
        'div',
        { className: styles$77.SkeletonBodyTextContainer },
        bodyTextLines
    );
}
...
var styles$78 = {
  ...
  "Content": "p_fj",
  "Header": "p_kx",
  "Header-hasSecondaryActions": "p_ll",
  "BreadcrumbAction": "p_il",
  "Actions": "p_c9",
  "Action": "p_if",
};
...
class SkeletonPage extends PureComponent {
    render() {
        ...
        const className = classNames$1(styles$78.Page, fullWidth && styles$78.fullWidth, singleColumn && styles$78.singleColumn);
        const headerClassName = classNames$1(styles$78.Header, breadcrumbs && styles$78['Header-hasBreadcrumbs'], secondaryActions && styles$78['Header-hasSecondaryActions']);
        ...
        const breadcrumbMarkup = breadcrumbs ? createElement(
            'div',
            { className: styles$78.BreadcrumbAction, style: { width: 60 } },
...
function renderSecondaryActions(actionCount) {
    ...
    for (let i = 0; i < actionCount; i++) {
        ...
        actions.push(createElement(
            'div',
            { className: styles$78.Action, style: { width }, key: i },
            createElement(SkeletonBodyText$1, { lines: 1 })
        ));
    }
    return createElement(
        'div',
        { className: styles$78.Actions },
        actions
    );
}
...
function ProgressBar$1({ progress = 0, size = 'medium', polaris: { intl } }) {
    const className = classNames$1(styles$79.ProgressBar, size && styles$79[variationName$1('size', size)]);
    ...
    return createElement(
        'div',
        { className: className },
        createElement('progress', { className: styles$79.Progress, value: parsedProgress, max: '100' }),
        createElement(
            'div',
            { className: styles$79.Indicator, style: { width: `${parsedProgress}%` } },
            createElement(
                'span',
                { className: styles$79.Label },
                parsedProgress,
                '%'
            )
        )
