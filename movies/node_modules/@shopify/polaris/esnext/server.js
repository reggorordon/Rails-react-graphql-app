...
function Icon$1({ source, color, backdrop, accessibilityLabel, polaris: { intl } }) {
    ...
    const className = styles.classNames(styles$3.Icon, color && styles$3[styles.variationName('color', color)], color && color !== 'white' && styles$3.isColored, backdrop && styles$3.hasBackdrop);
    let contentMarkup;
    if (source === 'placeholder') {
        contentMarkup = React.createElement('div', { className: styles$3.Placeholder });
    } else {
        const iconSource = typeof source === 'string' ? BUNDLED_ICONS[source] : source;
        contentMarkup = iconSource && iconSource.viewBox && iconSource.body && React.createElement('svg', { className: styles$3.Svg, viewBox: iconSource.viewBox, dangerouslySetInnerHTML: { __html: iconSource.body }, focusable: 'false', 'aria-hidden': 'true' });
    }
    return React.createElement(
        'span',
...
const Provider = _React$createContext.Provider;
const Consumer = _React$createContext.Consumer;
        ...
        class WithRef extends React.Component {
            render() {
                return React.createElement(
                    Consumer,
                    null,
                    ctx => React.createElement(WrappedComponent, Object.assign({}, this.props, { ref: ctx.forwardedRef }))
                );
            }
        }
...
function Badge$1({ children, status, progress, polaris: { intl } }) {
    const className = styles.classNames(styles$5.Badge, status && styles$5[styles.variationName('status', status)], progress && styles$5[styles.variationName('progress', progress)]);
    let progressMarkup;
    switch (progress) {
...
function Item$1({ badge, content, url, onAction, icon, image, disabled, external, destructive, ellipsis }) {
  const className = reactUtilities.classNames(styles$6.Item, disabled && styles$6.disabled, destructive && styles$6.destructive);
  ...
  if (icon) {
    ...
    imageElement = React.createElement('div', { role: 'presentation', className: styles$6.Image, style: { backgroundImage: `url(${image}` } });
  }
...
function Avatar$1({ name, source, initials, customer, size = 'medium', accessibilityLabel, polaris: { intl } }) {
    ...
    const className = styles.classNames(styles$7.Avatar, styles$7[styles.variationName('style', styleClass(nameString))], size && styles$7[styles.variationName('size', size)], finalSource && styles$7.hasImage);
    const imageMarkUp = finalSource ? React.createElement(Image$1, { className: styles$7.Image, source: finalSource, alt: '', role: 'presentation' }) : null;
...
function Spinner$1({ size = 'large', color = 'teal', accessibilityLabel, polaris: { intl } }) {
    ...
    const className = styles.classNames(styles$8.Spinner, color && styles$8[styles.variationName('color', color)], size && styles$8[styles.variationName('size', size)]);
...
function Indicator$1({ pulse = true }) {
    const className = styles.classNames(styles$9.Indicator, pulse && styles$9.pulseIndicator);
...
function Button$1({ id, url, disabled, loading, children, accessibilityLabel, ariaControls, ariaExpanded, onClick, onFocus, onBlur, external, icon, primary, outline, destructive, disclosure, plain, submit, size = 'medium', fullWidth, polaris: { intl } }) {
  ...
  const className = reactUtilities.classNames(styles$10.Button, primary && styles$10.primary, outline && styles$10.outline, destructive && styles$10.destructive, isDisabled && styles$10.disabled, loading && styles$10.loading, plain && styles$10.plain, size && size !== 'medium' && styles$10[reactUtilities.variationName('size', size)], fullWidth && styles$10.fullWidth, icon && children == null && styles$10.iconOnly);
  ...
  let iconMarkup;
  if (icon) {
    const iconInner = isIconSource(icon) ? React.createElement(Icon$2, { source: loading ? 'placeholder' : icon }) : icon;
...
class Item$3 extends React.PureComponent {
    ...
    render() {
        ...
        const className = styles.classNames(styles$12.Item, focused && styles$12['Item-focused'], button.props.plain && styles$12['Item-plain']);
        return React.createElement(
            'div',
...
function ButtonGroup$1({ children, segmented, fullWidth, connectedTop }) {
    const className = styles.classNames(styles$12.ButtonGroup, segmented && styles$12.segmented, fullWidth && styles$12.fullWidth, connectedTop && styles$12.connectedTop);
    const contents = reactUtilities.elementChildren(children).map((child, index) => React.createElement(Item$3, { button: child, key: index }));
    return React.createElement(
        'div',
        { className: className },
        contents
...
class Banner$1 extends React.PureComponent {
    render() {
        ...
        const className = styles.classNames(styles$13.Banner, status && styles$13[styles.variationName('status', status)], onDismiss && styles$13.hasDismiss, withinContentContainer ? styles$13.withinContentContainer : styles$13.withinPage);
        const id = uniqueID();
...
function Item$5({ children, fill }) {
    const className = styles.classNames(styles$15.Item, fill && styles$15['Item-fill']);
    return React.createElement(
        'div',
        { className: className },
        children
...
class Stack$1 extends React.PureComponent {
    render() {
        ...
        const className = styles.classNames(styles$15.Stack, vertical && styles$15.vertical, spacing && styles$15[styles.variationName('spacing', spacing)], distribution && styles$15[styles.variationName('distribution', distribution)], alignment && styles$15[styles.variationName('alignment', alignment)], wrap === false && styles$15.noWrap);
        const itemMarkup = reactUtilities.elementChildren(children).map((child, index) => {
            const props = { key: index };
            return reactUtilities.wrapWithComponent(child, Item$5, props);
        });
        return React.createElement(
            'div',
            { className: className },
...
function Section$3({ children, title, subdued, fullWidth }) {
  ...
  const className = styles.classNames(styles$16.Section, subdued && styles$16['Section-subdued'], fullWidth && styles$16['Section-fullWidth']);
  return React.createElement(
    'div',
    { className: className },
    headerContent,
...
class Card$1 extends React.PureComponent {
    ...
    render() {
        ...
        const className = styles.classNames(styles$16.Card, subdued && styles$16.subdued);
...
const Provider$1 = _React$createContext$1.Provider;
const Consumer$1 = _React$createContext$1.Consumer;
...
class FileUpload$1 extends React.Component {
    ...
    render() {
        ...
        const size = _props$context.size,
              type = _props$context.type;
        var _state2 = this.state;
        const actionTitle = _state2.actionTitle,
              actionHint = _state2.actionHint;

        const imageClasses = styles.classNames(styles$35.Image, size && size === 'extraLarge' && styles$35.sizeExtraLarge, size && size === 'large' && styles$35.sizeLarge);
...
class DropZone$1 extends React.Component {
    ...
    render() {
        ...
        const classes = styles.classNames(styles$36.DropZone, outline && styles$36.hasOutline, (active || dragging) && styles$36.isDragging, error && styles$36.hasError, size && size === 'extraLarge' && styles$36.sizeExtraLarge, size && size === 'large' && styles$36.sizeLarge, size && size === 'medium' && styles$36.sizeMedium, size && size === 'small' && styles$36.sizeSmall);
        ...
        const labelledDropzoneMarkup = label ? React.createElement(
            Labelled$1,
...
class EmptySearchResult$1 extends React.PureComponent {
    render() {
        ...
        const illustrationMarkup = withIllustration ? React.createElement(Image$1, { alt: altText, source: emptySearch, className: styles$37.Image, draggable: false }) : null;
        return React.createElement(
            Stack$1,
...
class EmptyState$1 extends React.PureComponent {
  render() {
    ...
    const className = styles.classNames(styles$38.EmptyState, imageContained && styles$38.imageContained);
    const imageMarkup = largeImage ? React.createElement(Image$1, { alt: '', role: 'presentation', className: styles$38.Image, source: largeImage, sourceSet: [{ source: image, descriptor: '568w' }, { source: largeImage, descriptor: '1136w' }], sizes: '(max-width: 568px) 60vw' }) : React.createElement(Image$1, { role: 'presentation', alt: '', className: styles$38.Image, source: image });
    const secondaryActionMarkup = secondaryAction ? buttonFrom(secondaryAction, { plain: true }) : null;
    return React.createElement(
      'div',
      { className: className },
...
function ExceptionList$1({ items: itemsList }) {
  const items = itemsList.map((item, index) => {
    ...
    const itemClasses = styles.classNames(styles$40.Item, status && styles$40[styles.variationName('status', status)]);
    const iconMarkup = icon ? React.createElement(Icon$2, { source: icon }) : React.createElement('span', { className: styles$40.Bullet });
    const titleMarkup = title && React.createElement(
      'span',
...
function Group$1({ children, condensed, title, helpText }) {
    const className = styles.classNames(condensed && styles$42.condensed);
...
function Section$5({ children, secondary, fullWidth }) {
    const className = styles.classNames(styles$44.Section, secondary && styles$44['Section-secondary'], fullWidth && styles$44['Section-fullWidth']);
    return React.createElement(
        'div',
        { className: className },
        children
...
function Header$3({ id, children, onClose }) {
  ...
  return React.createElement(
    ...
    React.createElement(CloseButton$1, { onClick: handleClose })
  );
}
...
function Section$7({ children, flush = false, subdued = false }) {
    const className = styles.classNames(styles$51.Section, flush && styles$51.flush, subdued && styles$51.subdued);
    return React.createElement(
        'section',
        { className: className },
        children
...
class Modal$2 extends React.Component {
    ...
    render() {
        ...
        if (open) {
            ...
            const bodyMarkup = src ? React.createElement('iframe', { name: iFrameName, title: iframeTitle, src: src, className: styles$52.IFrame, onLoad: this.handleIFrameLoad, style: { height: `${iframeHeight}px` } }) : React.createElement(
                Scrollable$2,
            ...
            const headerMarkup = title ? React.createElement(
                ...
                title
            ) : React.createElement(CloseButton$1, { onClick: handleClose, title: false });
            ...
            backdrop = React.createElement('div', { className: styles$52.Backdrop, onClick: handleClose });
        }
...
class Option$1 extends React.Component {
    ...
    render() {
        ...
        const singleSelectClassName = styles.classNames(styles$53.SingleSelectOption, focused && styles$53.focused, disabled && styles$53.disabled, select && styles$53.select, active && styles$53.active);
        const multiSelectClassName = styles.classNames(styles$53.Label, active && styles$53.active);
...
function Checkbox$4({ id = getUniqueID$6(), checked = false, disabled, active, onChange, name, value, role }) {
  const className = styles.classNames(styles$54.Checkbox, active && styles$54.active);
  return React.createElement(
    'div',
    { className: className },
    React.createElement('input', { id: id, name: name, value: value, type: 'checkbox', checked: checked, disabled: disabled, className: styles$54.Input, 'aria-checked': checked, onChange: onChange, role: role }),
    React.createElement('div', { className: styles$54.Backdrop }),
    React.createElement(
      'div',
...
function Action$1({ icon, url, external, onAction, children, disclosure, accessibilityLabel, disabled, showIndicator, hasIndicator }) {
  ...
  const className = reactUtilities.classNames(styles$56.Action, disabled && styles$56.disabled, icon && children == null && styles$56.iconOnly, false && showIndicator && styles$56['Action-outline']);
  return React.createElement(
    'button',
...
class Header$5 extends React.PureComponent {
    ...
    renderSecondaryActions() {
        ...
        const actionGroupsMarkup = actionGroups.length > 0 ? actionGroups.map(({ title, icon, actions, details }) => {
            const detailsClassName = styles.classNames(styles$56.Details, actions && Array.isArray(actions) && actions.length > 0 && styles$56.withActions);
            const detailsMarkup = details ? React.createElement(
                'div',
...
class Page$1 extends React.PureComponent {
    ...
    render() {
        ...
        const className = styles.classNames(styles$56.Page, fullWidth && styles$56.fullWidth, singleColumn && styles$56.singleColumn);
...
const Provider$2 = _React$createContext$2.Provider;
const Consumer$2 = _React$createContext$2.Consumer;
...
class FilterControl$1 extends React.Component {
    render() {
        ...
        const selectMode = _props$context.selectMode,
...
class Item$13 extends React.PureComponent {
    ...
    render() {
        ...
        const persistActions = _props$persistActions === undefined ? false : _props$persistActions,
              ...
              accessibilityLabel = _props.accessibilityLabel;
        var _props$context = _props.context;
        const selectable = _props$context.selectable,
    ...
    handleKeypress(event) {
        ...
        const onClick = _props4$onClick === undefined ? other.noop : _props4$onClick,
...
class Item$16 extends React.PureComponent {
    ...
    render() {
        ...
        const markup = url ? React.createElement(UnstyledLink$2, Object.assign({ url }, sharedProps), children) : React.createElement(
            'button',
...
function TextStyle$1({ variation, children }) {
    const className = styles.classNames(variation && styles$74[styles.variationName('variation', variation)], variation === VariationValue.Code && styles$74.code);
...
function Thumbnail$1({ source, alt, size = 'medium' }) {
    const className = styles.classNames(styles$75.Thumbnail, size && styles$75[styles.variationName('size', size)]);
    return React.createElement(
        'span',
        { className: className },
        React.createElement(Image$1, { alt: alt, source: source, className: styles$75.Image })
    );
}
...
function SkeletonDisplayText$1({ size = 'medium' }) {
    const className = styles.classNames(styles$76.DisplayText, size && styles$76[styles.variationName('size', size)]);
...
function SkeletonBodyText$1({ lines = 3 }) {
    ...
    for (let i = 0; i < lines; i++) {
        bodyTextLines.push(React.createElement('div', { className: styles$77.SkeletonBodyText, key: i }));
    }
    return React.createElement(
        'div',
...
class SkeletonPage extends React.PureComponent {
    render() {
        ...
        const className = styles.classNames(styles$78.Page, fullWidth && styles$78.fullWidth, singleColumn && styles$78.singleColumn);
        const headerClassName = styles.classNames(styles$78.Header, breadcrumbs && styles$78['Header-hasBreadcrumbs'], secondaryActions && styles$78['Header-hasSecondaryActions']);
        ...
        const breadcrumbMarkup = breadcrumbs ? React.createElement(
            'div',
...
function ProgressBar$1({ progress = 0, size = 'medium', polaris: { intl } }) {
    const className = styles.classNames(styles$79.ProgressBar, size && styles$79[styles.variationName('size', size)]);
    ...
    return React.createElement(
        'div',
        { className: className },
        React.createElement('progress', { className: styles$79.Progress, value: parsedProgress, max: '100' }),
        React.createElement(
            'div',
